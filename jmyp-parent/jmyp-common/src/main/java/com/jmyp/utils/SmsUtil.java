...
//    static final String accessKeySecret = "B3BZSQDnuUnfZXf22bbovyPaJmCNDt";
    ...
    public static SendSmsResponse sendSms(String telephone, String code) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("黑马");			//老袁a洗脚6
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_125028677"); 	//SMS_85550034
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
    	...
    	/**发送的电话号*/
    	String telephone = "15182241708";
        //发短信
        SendSmsResponse response = sendSms(telephone,"123233");
